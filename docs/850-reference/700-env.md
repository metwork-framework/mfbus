...
`MFBUS_HOME` | alias of `MFMODULE_HOME` if the current loaded metwork module is `mfbus` | `/opt/metwork-mfserv-0.8`
`MFBUS_VERSION` | alias of `MFMODULE_VERSION` if the current loaded metwork module is `mfbus` | `0.9.4`, `integration.ci1036.1949d86`
