...
MFBUS_VERSION=$("${MFEXT_HOME}/bin/guess_version.sh")
export MFBUS_VERSION
...
export MFMODULE=MFBUS
export MFMODULE_LOWERCASE=mfbus
...
echo "export MFMODULE_VERSION := ${MFBUS_VERSION}" >>adm/root.mk
...
echo "export ${MFMODULE}_VERSION := ${MFBUS_VERSION}" >>adm/root.mk
