...
#if test -f "${BUILDCACHE}/build_hash_mfbus_${BRANCH}_`cat .build_hash`"; then
...
#rm -f ${BUILDCACHE}/build_hash_mfbus_${BRANCH}_*
#touch ${BUILDCACHE}/build_hash_mfbus_${BRANCH}_`cat .build_hash`
#ls -l ${BUILDCACHE}
